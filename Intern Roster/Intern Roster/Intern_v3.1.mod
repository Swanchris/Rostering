...
forall(i in Intern, k in 1..51)
  4 -(sum(a in 0..3)x[i][2][k + a]) <= M*y;
forall(i in Intern, k in 1..51)
  x[i][2][k] <= M*(1-y);
  
forall(i in Intern, k in 1..51)
  4 -(sum(a in 0..3)x[i][3][k + a]) <= M*y;
forall(i in Intern, k in 1..51)
  x[i][3][k] <= M*(1-y);

forall(i in Intern, k in 1..51)
  4 -(sum(a in 0..3)x[i][4][k + a]) <= M*y;
forall(i in Intern, k in 1..51)
  x[i][4][k] <= M*(1-y);

forall(i in Intern, k in 1..53)
  2 -(sum(a in 0..1)x[i][5][k + a]) <= M*y;
forall(i in Intern, k in 1..53)
  x[i][5][k] <= M*(1-y);

forall(i in Intern, k in 1..52)
  3 -(sum(a in 0..2)x[i][6][k + a]) <= M*y;
forall(i in Intern, k in 1..52)
  x[i][6][k] <= M*(1-y);

forall(i in Intern, k in 1..52)
  3 -(sum(a in 0..2)x[i][7][k + a]) <= M*y;
forall(i in Intern, k in 1..52)
  x[i][7][k] <= M*(1-y);

forall(i in Intern, k in 1..53)
  2 -(sum(a in 0..1)x[i][8][k + a]) <= M*y;
forall(i in Intern, k in 1..53)
  x[i][8][k] <= M*(1-y);

forall(i in Intern, k in 1..51)
  4 -(sum(a in 0..3)x[i][9][k + a]) <= M*y;
forall(i in Intern, k in 1..51)
  x[i][9][k] <= M*(1-y);

forall(i in Intern, k in 1..52)
  3 -(sum(a in 0..2)x[i][10][k + a]) <= M*y;
forall(i in Intern, k in 1..52)
  x[i][10][k] <= M*(1-y);

forall(i in Intern, k in 1..50)
  5 -(sum(a in 0..4)x[i][11][k + a]) <= M*y;
forall(i in Intern, k in 1..50)
  x[i][11][k] <= M*(1-y);
