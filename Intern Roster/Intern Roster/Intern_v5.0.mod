...
forall(i in 1..6)
  sum(k in 51..54)x[i][16][k] ==4;
  
forall(i in 7..11)
  sum(k in 1..4)x[i][16][k] ==4;

forall(i in 1..6)
  sum(k in 1..50)x[i][16][k] ==0;
  
forall(i in 7..11)
  sum(k in 5..54)x[i][16][k] ==0;
...
//IP (j=9) 
forall(k in 5..50)
  sum(i in 1..6)x[i][9][k] <= 2;  
forall(k in 9..54)
  sum(i in 7..11)x[i][9][k] <= 2;

//DISP (j=10)    
forall(k in 5..50)
  sum(i in 1..6)x[i][10][k] <= 5;  
forall(k in 9..54)
  sum(i in 7..11)x[i][10][k] <= 5;
